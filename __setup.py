# I want to delte this file. is that ok?
# #!/usr/bin/env python
# # -*- coding: utf-8 -*-
...
# # no longer used. Pyproject.toml is used instead

# #DEFAULT_VERSION = "0.0.5"  # Invalid version
# with open("pyproject.toml", mode="rb") as fp:
#     pyproject = tomllib.load(fp)
#     DEFAULT_VERSION = pyproject.get("project", {}).get("version", DEFAULT_VERSION)
...
#     #long_description=long_description, # covered by readme.md
